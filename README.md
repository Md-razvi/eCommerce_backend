...
In this project, I created API endpoints to manage Categories and Products.
The application allows adding and retrieving products and categories through REST APIs.
